...
>
    ...
    <?php else: ?>
        <div class="price_day_row" data-row="0">
            <div class="form-group">
                <label class="control-label" for="min_capacity0"><?= $model->getAttributeLabel('min_capacity') ?> 1</label>
            ...
            <div class="form-group">
                <label class="control-label" for="max_capacity0"><?= $model->getAttributeLabel('max_capacity') ?> 1</label>
            ...
            <div class="form-group">
                <label class="control-label" for="price0"><?= $model->getAttributeLabel('price_day') ?> 1</label>
