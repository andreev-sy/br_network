...
return [
    ...
    'controllerNamespace' => 'backend\modules\moybanket\controllers',
    'bootstrap' => ['log','moybanket'],
    'modules' => [
        'moybanket' => [
            'class' => 'backend\modules\moybanket\Module',
        ],
    ],
    'components' => [
        'request' => [
        ...
        'view' => [
            'theme' => [
                'pathMap' => [
                    '@app/views' => '@app/modules/moybanket/views',
                ],
            ],
        ],
        'user' => [
