...
export const GET_BLOCKS =
    '/api/blog-blocks/?fields=id,name,type&expand=blockTypeLabel';
export const API_DRAFT_BLOCKS = '/api/blog-post-blocks/';
export const GET_DRAFT_BLOCKS = `${API_DRAFT_BLOCKS}?expand=${BLOCK_REL_NAME},mediaTargets`;
export const POST_BLOCKS_SORTINGS = '/api/blog-post-blocks/sort/';
