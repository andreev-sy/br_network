...
/**
 * This is the model class for table "collection_guest".
 *
 * @property int $id
 ...
 */
class CollectionGuest extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Collection::className(), ['guest_id' => 'id']);
    }
}
