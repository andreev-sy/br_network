...
use backend\models\WidgetMainSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * WidgetMainController implements the CRUD actions for WidgetMain model.
 */
class WidgetMainController extends BaseBackendController
{
    /**
     * {@inheritdoc}
     */
