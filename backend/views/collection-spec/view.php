...
?>
<div class="collection-spec-view box box-primary">
    <?php if(Yii::$app->user->can('/collection-spec/update') or Yii::$app->user->can('/collection-spec/delete')): ?>
        <div class="box-header">
            <?php if(Yii::$app->user->can('/collection-spec/update')): ?>
                <?= Html::a(Yii::t('app', 'Изменить'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat']) ?>
            <?php endif; ?>
            <?php if(Yii::$app->user->can('/collection-spec/delete')): ?>
