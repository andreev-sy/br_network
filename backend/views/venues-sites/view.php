...
?>
<div class="venues-sites-view box box-primary">
    <?php if(Yii::$app->user->can('/venues-sites/update') or Yii::$app->user->can('/venues-sites/delete')): ?>
        <div class="box-header">
            <?php if(Yii::$app->user->can('/venues-sites/update')): ?>
                <?= Html::a(Yii::t('app', 'Изменить'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat']) ?>
            <?php endif; ?>
            <?php if(Yii::$app->user->can('/venues-sites/delete')): ?>
