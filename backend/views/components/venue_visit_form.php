...
$this->registerJs($js);
?>
<div class="box-body venues_visit">

<?php Pjax::begin(['id' => 'vanues_visit']); ?>

<?php $venues_visit = VenuesVisit::findOne(['venue_id' => $model->id]) ?? new VenuesVisit(); ?>
<br>
<?php $form = ActiveForm::begin(['options' => ['data-pjax' => true, 'id' => 'form_venues_visit']]); ?>
...
<?php if (!empty($visit_all)): ?>
    <?php foreach ($visit_all as $key => $visit): ?>
        <?php $form = ActiveForm::begin(['options' => ['data-pjax' => true, 'id' => 'form_visit' . $key]]); ?>
        <div class="row visit_wrap">
            <div class="col-md-6">
                ...
                ])->label($visit->getAttributeLabel('date') . ' ' . ($key + 1)) ?>
                <?= $form->field($visit, 'comment')->textarea(['rows' => 5])->label($visit->getAttributeLabel('comment') . ' ' . ($key + 1)) ?>
            </div>
            <div class="col-md-6">
                <div class="form-group">
...
<?php $form = ActiveForm::begin(['options' => ['data-pjax' => true, 'id' => 'form_new_visit']]); ?>
<div class="row visit_wrap hidden">
    <div class="col-md-6">
