...
?>
<div class="collection-guest-view box box-primary">
    <?php if(Yii::$app->user->can('/collection-guest/update') or Yii::$app->user->can('/collection-guest/delete')): ?>
        <div class="box-header">
            <?php if(Yii::$app->user->can('/collection-guest/update')): ?>
                <?= Html::a(Yii::t('app', 'Изменить'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat']) ?>
            <?php endif; ?>
            <?php if(Yii::$app->user->can('/collection-guest/delete')): ?>
