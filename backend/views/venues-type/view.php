...
?>
<div class="venues-type-view box box-primary">
    <?php if(Yii::$app->user->can('/venues-type/update') or Yii::$app->user->can('/venues-type/delete')): ?>
        <div class="box-header">
            <?php if(Yii::$app->user->can('/venues-type/update')): ?>
                <?= Html::a(Yii::t('app', 'Изменить'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat']) ?>
            <?php endif; ?>
            <?php if(Yii::$app->user->can('/venues-type/delete')): ?>
