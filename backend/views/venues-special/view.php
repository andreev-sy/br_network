...
?>
<div class="venues-special-view box box-primary">
    <?php if(Yii::$app->user->can('/venues-special/update') or Yii::$app->user->can('/venues-special/delete')): ?>
        <div class="box-header">
            <?php if(Yii::$app->user->can('/venues-special/update')): ?>
                <?= Html::a(Yii::t('app', 'Изменить'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat']) ?>
            <?php endif; ?>
            <?php if(Yii::$app->user->can('/venues-special/delete')): ?>
