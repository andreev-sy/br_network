    ...
    <div class="box-body">
        ...
        <?= SortableGridView::widget([
            ...
            [
                ...
                'format'=>'html',
                'value'=>function($data){
                    if(empty($data->venue)) return null;
            ...
            [
                ...
                'format'=>'raw',
                'value'=>function($data){
                    return Html::checkbox('active', ($data->active == 1), [
                        'disabled'=> !Yii::$app->user->can('/collection/ajax-set-venue'),
                        'onchange' => new JsExpression('
                            function handleCheckboxChange(){
                                let set = $(this).prop("checked");
                                $.post("'.Url::to(['collection/ajax-set-venue']).'", { set: set, id: '.$data->id.' }, function(data){
                                    console.log(data);
                                });
                            }
