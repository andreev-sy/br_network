 ...
 * @var common\models\search\BlogTag $searchModel
 */
$this->title = Yii::t('models', 'Blog Tags');
...
?>
<div class="giiant-crud blog-tag-index">
	...
	<h1>
		<?php echo Yii::t('models', 'Blog Tags') ?>
		<small>
			List
		</small>
	</h1>
					...
					[
						...
						'dropdown' => [
							...
							'items' => [
								...
								[
									'url' => ['/blog-post/index'],
									'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Blog Post'),
								],
								[
									'url' => ['/user/index'],
