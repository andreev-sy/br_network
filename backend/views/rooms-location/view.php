...
?>
<div class="rooms-location-view box box-primary">
    <?php if(Yii::$app->user->can('/rooms-location/update') or Yii::$app->user->can('/rooms-location/delete')): ?>
        <div class="box-header">
            <?php if(Yii::$app->user->can('/rooms-location/update')): ?>
                <?= Html::a(Yii::t('app', 'Изменить'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-flat']) ?>
            <?php endif; ?>
            <?php if(Yii::$app->user->can('/rooms-location/delete')): ?>
