...
class Seo extends BaseObject
{
	...
	private function setSeo($seoObj, $page)
	{
		...
		if (!empty($seoObj->seoObject)) {
			if ($page == 1) {
				$this->seo['title'] 		= $seoObj->seoObject->title;
				$this->seo['description'] 	= $seoObj->seoObject->description;
				$this->seo['keywords'] 		= $seoObj->seoObject->keywords;
				$this->seo['h1'] 			= $seoObj->seoObject->heading;
				$this->seo['h1_pag'] 		= $seoObj->seoObject->pagination_heading;
				$this->seo['text_top']		= $seoObj->seoObject->text1;
				$this->seo['text_bottom']	= $seoObj->seoObject->text2;
			} else {
				$this->seo['title'] 		= $seoObj->seoObject->pagination_title;
				$this->seo['description'] 	= $seoObj->seoObject->pagination_description;
				$this->seo['keywords'] 		= $seoObj->seoObject->pagination_keywords;
				$this->seo['h1'] 			= $seoObj->seoObject->pagination_heading;
				$this->seo['h1_pag'] 		= $seoObj->seoObject->pagination_heading;
				$this->seo['text_top']		= '';
