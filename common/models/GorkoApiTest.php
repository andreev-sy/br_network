...
class GorkoApiTest extends Model
{
	...
	public function showOne($params) {
		foreach ($params as $param) {
			$api_url = 'https://api.gorko.ru/api/v2/restaurants/3537?embed=rooms,contacts&fields=address,params,covers,district,metro,specs,room_specs&is_edit=1&com=sat';
